...
/// <summary>
/// Centralized list of HoYoLAB-related domains. Compose full endpoints in services using these hosts.
/// </summary>
public static class HoYoLabDomains
{
    ...
    /// </summary>
    public const string WikiApi = "https://sg-wiki-api-static.hoyolab.com";
}
