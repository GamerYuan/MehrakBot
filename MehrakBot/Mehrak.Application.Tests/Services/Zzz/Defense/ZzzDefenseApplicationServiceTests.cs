...
public class ZzzDefenseApplicationServiceTests
{
    ...
    {
        // Arrange
        (ZzzDefenseApplicationService? service, Mock<IApiService<ZzzDefenseData, BaseHoYoApiContext>> _, Mock<IImageUpdaterService> _, Mock<IApiService<GameProfileDto, GameRoleApiContext>>? gameRoleApiMock, Mock<ICardService<ZzzDefenseData>> _, Mock<IUserRepository> _) = SetupMocks();
    ...
    {
        // Arrange
        (ZzzDefenseApplicationService? service, Mock<IApiService<ZzzDefenseData, BaseHoYoApiContext>>? defenseApiMock, Mock<IImageUpdaterService> _, Mock<IApiService<GameProfileDto, GameRoleApiContext>>? gameRoleApiMock, Mock<ICardService<ZzzDefenseData>> _, Mock<IUserRepository> _) = SetupMocks();
    ...
    {
        // Arrange
        (ZzzDefenseApplicationService? service, Mock<IApiService<ZzzDefenseData, BaseHoYoApiContext>>? defenseApiMock, Mock<IImageUpdaterService>? imageUpdaterMock, Mock<IApiService<GameProfileDto, GameRoleApiContext>>? gameRoleApiMock, Mock<ICardService<ZzzDefenseData>> _, Mock<IUserRepository> _) = SetupMocks();

        gameRoleApiMock.Setup(x => x.GetAsync(It.IsAny<GameRoleApiContext>()))
            .ReturnsAsync(Result<GameProfileDto>.Success(CreateTestProfile()));

        ZzzDefenseData defenseData = await LoadTestDataAsync("Shiyu_TestData_1.json");
        defenseApiMock.Setup(x => x.GetAsync(It.IsAny<BaseHoYoApiContext>()))
            .ReturnsAsync(Result<ZzzDefenseData>.Success(defenseData));
    ...
    {
        // Arrange
        (ZzzDefenseApplicationService? service, Mock<IApiService<ZzzDefenseData, BaseHoYoApiContext>>? defenseApiMock, Mock<IImageUpdaterService>? imageUpdaterMock, Mock<IApiService<GameProfileDto, GameRoleApiContext>>? gameRoleApiMock, Mock<ICardService<ZzzDefenseData>>? cardServiceMock, Mock<IUserRepository> _) = SetupMocks();

        gameRoleApiMock.Setup(x => x.GetAsync(It.IsAny<GameRoleApiContext>()))
            .ReturnsAsync(Result<GameProfileDto>.Success(CreateTestProfile()));

        ZzzDefenseData defenseData = await LoadTestDataAsync(testDataFile);
        defenseApiMock.Setup(x => x.GetAsync(It.IsAny<BaseHoYoApiContext>()))
            .ReturnsAsync(Result<ZzzDefenseData>.Success(defenseData));
    ...
    {
        // Arrange
        (ZzzDefenseApplicationService? service, Mock<IApiService<ZzzDefenseData, BaseHoYoApiContext>>? defenseApiMock, Mock<IImageUpdaterService> _, Mock<IApiService<GameProfileDto, GameRoleApiContext>>? gameRoleApiMock, Mock<ICardService<ZzzDefenseData>> _, Mock<IUserRepository>? userRepositoryMock) = SetupMocks();
    ...
    {
        // Arrange
        (ZzzDefenseApplicationService? service, Mock<IApiService<ZzzDefenseData, BaseHoYoApiContext>>? defenseApiMock, Mock<IImageUpdaterService> _, Mock<IApiService<GameProfileDto, GameRoleApiContext>>? gameRoleApiMock) = SetupIntegrationTest();
    ...
    public async Task IntegrationTest_WithRealApi_FullFlow()
    {
        ...
        ZzzDefenseApplicationService service = SetupRealApiIntegrationTest();
    ...
    private static async Task<ZzzDefenseData> LoadTestDataAsync(string filename)
    {
        ...
        ZzzDefenseData? result = JsonSerializer.Deserialize<ZzzDefenseData>(json);
