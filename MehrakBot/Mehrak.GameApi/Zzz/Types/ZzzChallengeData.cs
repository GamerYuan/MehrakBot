...
public class ZzzBuddy
{
    ...
    public string BangbooRectangleUrl { get; init; }
...
{
    [JsonPropertyName("begin_time")] public string BeginTime { get; init; }
    [JsonPropertyName("end_time")] public string EndTime { get; init; }
    [JsonPropertyName("rating_list")] public List<RatingData> RatingList { get; init; }
    [JsonPropertyName("has_data")] public bool HasData { get; init; }
    [JsonPropertyName("all_floor_detail")] public List<FloorDetail> AllFloorDetail { get; init; }
}

public class ZzzAssaultData
{
    [JsonPropertyName("start_time")] public ScheduleTime StartTime { get; init; }
    [JsonPropertyName("end_time")] public ScheduleTime EndTime { get; init; }
    [JsonPropertyName("rank_percent")] public int RankPercent { get; init; }
    [JsonPropertyName("list")] public List<AssaultFloorDetail> List { get; init; }
    [JsonPropertyName("has_data")] public bool HasData { get; init; }
...
public class FloorDetail
{
    ...
    [JsonPropertyName("rating")] public string Rating { get; init; }
    [JsonPropertyName("node_1")] public NodeData Node1 { get; init; }
    [JsonPropertyName("node_2")] public NodeData Node2 { get; init; }
    [JsonPropertyName("zone_name")] public string ZoneName { get; init; }
}

public class NodeData
{
    [JsonPropertyName("avatars")] public List<ZzzChallengeAvatar> Avatars { get; init; }
    [JsonPropertyName("buddy")] public ZzzBuddy? Buddy { get; init; }
...
public class AssaultFloorDetail
{
    ...
    [JsonPropertyName("boss")] public List<AssaultBoss> Boss { get; init; }
    [JsonPropertyName("avatar_list")] public List<ZzzChallengeAvatar> AvatarList { get; init; }
    [JsonPropertyName("buffer")] public List<AssaultBuff> Buff { get; init; }
    [JsonPropertyName("buddy")] public ZzzBuddy? Buddy { get; init; }
}
...
public class AssaultBoss
{
    ...
    [JsonPropertyName("bg_icon")] public string BgIcon { get; init; }
