...
{
    [JsonPropertyName("characters")] public List<Hi3BasicCharacterInfo> Characters { get; init; }
}

public class Hi3BasicCharacterInfo
{
    [JsonPropertyName("character")] public Hi3CharacterDetail Character { get; init; }
}

public class Hi3CharacterDetail
{
    [JsonPropertyName("avatar")] public Hi3Avatar Avatar { get; init; }
    [JsonPropertyName("weapon")] public Hi3Weapon Weapon { get; init; }
    [JsonPropertyName("stigmatas")] public List<Hi3Stigmata> Stigmatas { get; init; }
    [JsonPropertyName("costumes")] public List<Hi3Costume> Costumes { get; init; }
}
