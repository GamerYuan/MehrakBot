...
public interface IUserPortraitService
{
    ...
    Task<UploadPortraitResult> UploadPortraitAsync(long discordUserId, Game game, string characterName, Stream imageStream, string sha256, CancellationToken ct = default);
