...
public class ZzzAvatarData
{
    ...
    [JsonPropertyName("full_name_mi18n")] public required string FullName { get; set; }

    [JsonPropertyName("element_type")] public int ElementType { get; set; }

    [JsonPropertyName("camp_name_mi18n")] public required string CampName { get; set; }
    ...
    [JsonPropertyName("group_icon_path")] public required string GroupIconPath { get; set; }

    [JsonPropertyName("hollow_icon_path")] public required string HollowIconPath { get; set; }

    [JsonPropertyName("equip")] public required List<DiskDrive> Equip { get; set; }

    [JsonPropertyName("weapon")] public Weapon? Weapon { get; set; }

    [JsonPropertyName("properties")] public required List<CharacterProperty> Properties { get; set; }

    [JsonPropertyName("skills")] public required List<Skill> Skills { get; set; }
...
{
    [JsonPropertyName("avatar_list")] public required List<ZzzAvatarData> AvatarList { get; set; }
    ...
    [JsonPropertyName("avatar_wiki")] public required Dictionary<string, string> AvatarWiki { get; set; }
...
public class DiskDrive
{
    ...
    [JsonPropertyName("properties")] public required List<EquipProperty> Properties { get; set; }

    [JsonPropertyName("main_properties")] public required List<EquipProperty> MainProperties { get; set; }

    [JsonPropertyName("equip_suit")] public required EquipSuit EquipSuit { get; set; }
...
public sealed class EquipSuit : IEquatable<EquipSuit>
{
    ...
    [JsonPropertyName("desc1")] public required string Desc1 { get; set; }

    [JsonPropertyName("desc2")] public required string Desc2 { get; set; }
...
{
    [JsonPropertyName("property_name")] public required string PropertyName { get; set; }

    [JsonPropertyName("property_id")] public int PropertyId { get; set; }

    [JsonPropertyName("base")] public required string Base { get; set; }
...
public class CharacterProperty
{
    ...
    [JsonPropertyName("add")] public required string Add { get; set; }

    [JsonPropertyName("final")] public required string Final { get; set; }
}
...
public class Skill
{
    ...
    [JsonPropertyName("items")] public required List<SkillDetails> Items { get; set; }
...
public class Weapon
{
    ...
    [JsonPropertyName("talent_title")] public required string TalentTitle { get; set; }

    [JsonPropertyName("talent_content")] public required string TalentContent { get; set; }
