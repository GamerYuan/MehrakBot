...
Mehrak is eligible for the community license as a hobby/open-source project. A build-time license file - `sixlabors.lic` is required to compile Mehrak locally. This license file should be placed under `MehrakBot/Services/Application/Mehrak.Application`, as this is the only project that directly depends on ImageSharp. More about licensing can be found here: https://sixlabors.com/posts/licence-enforcement-changes/
