export const gameConfigs = {
  genshin: {
    ...
    tabs: [
      ...
      { id: 'abyss', name: 'Spiral Abyss', hasFloorInput: true, floorMin: 9, floorMax: 12 },
  ...
  hi3: {
    ...
    tabs: [
      { id: 'battlesuit', name: 'Battlesuit', hasCharacterInput: true, characterLabel: 'Battlesuit Name' },
    ],
