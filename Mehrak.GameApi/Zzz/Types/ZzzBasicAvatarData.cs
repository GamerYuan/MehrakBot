...
public class ZzzBasicAvatarData
{
    ...
    public required string GroupIconPath { get; init; }

    [JsonPropertyName("hollow_icon_path")]
    public required string HollowIconPath { get; init; }
    ...
    public required string RoleSquareUrl { get; init; }

    [JsonPropertyName("sub_element_type")]
    public int SubElementType { get; init; }

    [JsonPropertyName("awaken_state")]
    public required string AwakenState { get; init; }
}
